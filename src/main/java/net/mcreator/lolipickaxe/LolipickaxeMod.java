...
import net.mcreator.lolipickaxe.init.LolipickaxeModSounds;
...
public class LolipickaxeMod {
	public static final Logger LOGGER = LogManager.getLogger(LolipickaxeMod.class);
	public static final String MODID = "lolipickaxe";

	public LolipickaxeMod() {
		MinecraftForge.EVENT_BUS.register(this);
		LolipickaxeModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		LolipickaxeModSounds.REGISTRY.register(bus);

		LolipickaxeModItems.REGISTRY.register(bus);
		LolipickaxeModEntities.REGISTRY.register(bus);
