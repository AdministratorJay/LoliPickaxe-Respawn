...
public class SetAutoAttackProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
			...
			return;
		{
			...
			entity.getCapability(LolipickaxeModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
				capability.AT = _setval;
				capability.syncPlayerVariables(entity);
			});
		}
		if (entity instanceof Player _player && !_player.level.isClientSide())
			_player.displayClientMessage(Component.literal(("\u00A74\u8BBE\u7F6E\u00A7r\u4E86'\u00A7e\u81EA\u52A8\u653B\u51FB\u00A7r'\u7684\u503C\u4E3A\uFF1A"
					+ (entity.getCapability(LolipickaxeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new LolipickaxeModVariables.PlayerVariables())).AT)), (false));
	}
}
