...
public class SetFanShangProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (entity instanceof Player _player && !_player.level.isClientSide())
			_player.displayClientMessage(Component.literal(("\u00A74\u8BBE\u7F6E\u00A7r\u4E86'\u00A7e\u53CD\u4F24\u00A7r'\u7684\u503C\u4E3A\uFF1A"
					+ (entity.getCapability(LolipickaxeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new LolipickaxeModVariables.PlayerVariables())).FS)), (false));
	}
}
